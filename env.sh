...
export LADT_MAX_ENTRIES=45000 # limits the number of entries returned from Elasticsearch for the training query
...
export LADI_MAX_ENTRIES=2500 # limits the number of entries returned from Elasticsearch for the inference query
