...
export LADI_MAX_ENTRIES=3500 # limits the number of entries returned from Elasticsearch for the inference query
...
export LADI_CHUNK_SIZE=400 # Chunk size for bulk upload of logs to ES